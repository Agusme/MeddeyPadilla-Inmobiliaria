    ...
    <section
      className={
        overlay
          ...
          : "rounded-xl border border-black/10 bg-white p-4 shadow-[0_18px_45px_-22px_rgba(0,0,0,0.38)] sm:p-5"
      }
    ...
    >
      ...
      >
        ...
        <button
          ...
          className={`flex items-center justify-center rounded-md bg-[#B71C1C] text-white shadow-lg shadow-[#B71C1C]/25 transition hover:bg-[#8F1616] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#B71C1C] ${overlay ? "h-16 w-16" : "h-12 w-14 justify-self-start lg:justify-self-end"}`}
        >
          <svg
            aria-hidden="true"
